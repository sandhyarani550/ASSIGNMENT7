...
Find the ratio in  which the line segment joining the points \myvec{4 \\ 8 \\ 10} and \myvec{6 \\ 10 \\ -8} is divided by YZ-plane. 
\section{Solution}
\begin{enumerate}
\item Given 
\begin{align}
...
\end{align}
Let A, B are the given points an divides the line segment joining these points in ratio $k:1$.
\eqref{eq:1},
\begin{align}
\vec{P}=\frac{k\myvec{4\\8\\10}+1\myvec{6\\10\\-8}}
{(k+1)}
\\
\implies\vec{P}=\myvec{{\frac{6k+4}{k+1}} \\ {\frac{10k+8}{k+1}} \\ {\frac{-8k+10}{k+1}}}
\end{align}
